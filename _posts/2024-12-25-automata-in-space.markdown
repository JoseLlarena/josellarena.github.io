...
PDF [Automata in Space: Formal Language Theory meets Neural Computation](/assets/doc/ais-paper-v3.pdf).
...
@unpublished{llarena2024automata,
  ...
  note      = {https://josellarena.github.io/assets/doc/ais-paper-v3.pdf},
  year      = {2024}
}
```
